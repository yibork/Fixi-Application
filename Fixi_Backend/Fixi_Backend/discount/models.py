...
from Fixi_Backend.Catalogue.models import Service, Taxonomy
...
class Campaign(models.Model):
    ...
    apply_to = models.CharField(max_length=8,
                                ...
                                default="product",
                                null=False)
    target_product = models.ForeignKey(Service, on_delete=models.SET_NULL, null=True, blank=True)
    target_category = models.ForeignKey(Taxonomy, on_delete=models.SET_NULL, null=True, blank=True)
